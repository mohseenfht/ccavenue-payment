	...
	<form method="post" name="customerData" action="ccavRequestHandler.php">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<tr>
					<input type="hidden" name="merchant_id" value="88265"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://tripathionlineeducare.com/tripathi/admin/"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://tripathionlineeducare.com/tripathi/admin/"/></td>
			 	</tr>
			 	<tr>
